...
router.post("/forgot-password", async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      text: `This is your link to reset your password, its valid for 1 hour: https://finance-tracking-app-api-service-743940785467.asia-southeast2.run.app/user/reset-password-view/${token}`,
    };
